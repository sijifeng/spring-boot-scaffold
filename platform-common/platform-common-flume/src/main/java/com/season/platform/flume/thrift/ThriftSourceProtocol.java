...
public class ThriftSourceProtocol {
  ...
  public interface AsyncIface {
    ...
    public void append(ThriftFlumeEvent event, AsyncMethodCallback resultHandler) throws TException;

    public void appendBatch(List<ThriftFlumeEvent> events, AsyncMethodCallback resultHandler) throws TException;
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class append_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public append_call(ThriftFlumeEvent event, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
    ...
    public static class appendBatch_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public appendBatch_call(List<ThriftFlumeEvent> events, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.events = events;
      }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class appendBatch<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, appendBatch_args, Status> {
      ...
      public void start(I iface, appendBatch_args args, AsyncMethodCallback<Status> resultHandler) throws TException {
  ...
  public static class append_args implements org.apache.thrift.TBase<append_args, append_args._Fields>, java.io.Serializable, Cloneable, Comparable<append_args>   {
    ...
    private static class append_argsStandardScheme extends StandardScheme<append_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, append_args struct) throws TException {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, append_args struct) throws TException {
        struct.validate();
    ...
    private static class append_argsTupleScheme extends TupleScheme<append_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, append_args struct) throws TException {
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, append_args struct) throws TException {
  ...
  public static class append_result implements org.apache.thrift.TBase<append_result, append_result._Fields>, java.io.Serializable, Cloneable, Comparable<append_result>   {
    ...
    private static class append_resultStandardScheme extends StandardScheme<append_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, append_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, append_result struct) throws TException {
        struct.validate();
    ...
    private static class append_resultTupleScheme extends TupleScheme<append_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, append_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, append_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = com.sijifeng.framework.study.thrift.flume.Status.findByValue(iprot.readI32());
  ...
  public static class appendBatch_args implements org.apache.thrift.TBase<appendBatch_args, appendBatch_args._Fields>, java.io.Serializable, Cloneable, Comparable<appendBatch_args>   {
    ...
    private static class appendBatch_argsStandardScheme extends StandardScheme<appendBatch_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, appendBatch_args struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, appendBatch_args struct) throws TException {
        struct.validate();
    ...
    private static class appendBatch_argsTupleScheme extends TupleScheme<appendBatch_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, appendBatch_args struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, appendBatch_args struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          {
  ...
  public static class appendBatch_result implements org.apache.thrift.TBase<appendBatch_result, appendBatch_result._Fields>, java.io.Serializable, Cloneable, Comparable<appendBatch_result>   {
    ...
    private static class appendBatch_resultStandardScheme extends StandardScheme<appendBatch_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, appendBatch_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, appendBatch_result struct) throws TException {
        struct.validate();
    ...
    private static class appendBatch_resultTupleScheme extends TupleScheme<appendBatch_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, appendBatch_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, appendBatch_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = com.sijifeng.framework.study.thrift.flume.Status.findByValue(iprot.readI32());
