...
public class BaiduImageCrawler extends ImageCrawler {
	...
	//lm:-1 (6动态图片 7静态图片)
	//gsm:3c pn值的十六进制数
	private static final String BAIDU_IMAGE_SEARCH_URL = "http://image.baidu.com/search/avatarjson?tn=resultjsonavatarnew&ie=utf-8&cg=&word=%s&pn=%d&rn=%d&itg=0&z=3&ic=0&s=0&face=0&st=-1&lm=-1&gsm=%s";
